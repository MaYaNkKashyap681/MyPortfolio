...
const Works = () => {
  return (
    <>
      ...
      <div
        className=" bg-blue-500 mt-[30px] cursor-pointer hover:bg-blue-400 max-w-[300px] p-4 flex justify-center items-center"
        onClick={() =>
          window.open(
            "https://drive.google.com/drive/folders/1zzHrhsPdo9bs9EDAO5SDbLROn5qhTdt0?usp=share_link",
            "_blank"
          )
        }
      >
